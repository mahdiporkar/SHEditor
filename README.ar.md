...
نظام الصور الاحترافي وpicker وupload adapter والسحب/الإفلات واللصق وتغيير الحجم والتعليق وalt/title والمحاذاة والصور المرتبطة والمتجاوبة **غير منفذة**. لا نوثق endpoint أو API وهمياً.

## الجداول

نموذج الجدول وتحديد الخلايا وعمليات الصفوف والأعمدة والدمج والتقسيم وتغيير الحجم والحافظة والتسلسل الاحترافي **غير منفذة** وتظهر بوضوح كميزات قادمة.
