...
One floating-layer foundation, dialogs, bubble menu, slash commands, find/replace, source mode, paste pipeline, Word/Docs cleanup, statistics and responsive overflow.

## 0.5 Enterprise modules
