...
const SAFE_TAGS = ['P','BR','H1','H2','H3','H4','H5','H6','BLOCKQUOTE','PRE','CODE','STRONG','B','EM','I','U','S','DEL','A','UL','OL','LI','HR'];
const SAFE_ATTRS: Record<string, string[]> = { A: ['href','title','target','rel'] };
